...
- Harden tool layer: allowlist + cwd sandbox + timeout/output truncation for `run_shell`; diff-based `apply_patch`; stronger tool schema (typed JSON schema inference); partial reads to avoid huge contexts.
